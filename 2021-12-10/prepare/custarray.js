const customers = getCustomers().slice(14,19);

console.log(customers.length);
const payingCustomers = [];
for (cust of customers) {
	payingCustomers.push(cust.companyName);
}
payingCustomers.pop();
payingCustomers.shift();
payingCustomers.unshift('Mountain Sports');
payingCustomers.sort();
payingCustomers.splice(1, 1, 'ERROR');
payingCustomers.unshift('new one');
console.log(payingCustomers.indexOf('ERROR'));
payingCustomers.push("ERROR");
console.log(payingCustomers.lastIndexOf('ERROR'));
console.log(payingCustomers);
console.log(payingCustomers.includes('ERROR'));
